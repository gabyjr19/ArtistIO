...
<html lang="en">
    <head>
        ...
        <title>ArtistIO - Artworks Detail</title>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-info d-flex">
                                <div>
                                    ...
                                    <p class="product-p">Original from Gabriel Mungai</p>
                                </div>
                            ...
                            <div class="product-description">
                                ...
                                <p class="lead mb-5">Showcasing humanity</p>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="assets/images/product/evan-mcdougall-qnh1odlqOmk-unsplash.jpeg" class="img-fluid product-image" alt="">
                                </a>
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="product-detail.html" class="product-title-link">Tears</a>
                                        </h5>

                                        <p class="product-p">Showcasing humanity</p>
                                    </div>

                                    <small class="product-price text-muted ms-auto mt-auto mb-5">$250000</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="assets/images/product/jordan-nix-CkCUvwMXAac-unsplash.jpeg" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="assets/images/product/nature-zen-3Dn1BZZv3m8-unsplash.jpeg" class="img-fluid product-image" alt="">
                                </a>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12 mt-3 mt-lg-0">
                                <h3 class="modal-title" id="exampleModalLabel">Tears</h3>

                                <p class="product-price text-muted mt-3">$250000</p>

                               <!-- <p class="product-p">Quatity: <span class="ms-1">4</span></p>-->

                                <p class="product-p">Type: <span class="ms-1">Oil Painting</span></p>

                                <p class="product-p pb-3">Size: <span class="ms-1">S/S</span></p>

                                <div class="border-top mt-4 pt-3">
                                    <p class="product-p"><strong>Total: <span class="ms-1">Sh250000</span></strong></p>
                                </div>
                    ...
                    <div class="modal-footer">
                        <div class="row w-50">
                        <a href="{{ route('checkout') }}" class="btn custom-btn cart-btn ms-lg-4">Checkout</a>
                        </div>
                    </div>
                </div>
